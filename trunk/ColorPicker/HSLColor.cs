...
namespace ColorPicker
{
	public struct HSLColor 
	{
		...
		Color ToRGB()
		{
            ...
            int red = Convert.ToInt32(Math.Round(colors[0], 0, MidpointRounding.AwayFromZero));
            int green = Convert.ToInt32(Math.Round(colors[1], 0, MidpointRounding.AwayFromZero));
            int blue = Convert.ToInt32(Math.Round(colors[2], 0, MidpointRounding.AwayFromZero));
