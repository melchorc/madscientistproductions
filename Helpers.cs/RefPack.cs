...
namespace MadScience.RefPack
{
    ...
    public class Decompression
    {
        public static byte[] Decompress(byte[] input)
        {
            ...
            return MadScience.RefPack.Decompression.Decompress(data);
            //return data.RefPackDecompress();
        }

        public static byte[] Decompress(Stream input)
        {
            UInt16 header = MadScience.StreamHelpers.ReadValueU16(input, false);
            ...
            UInt32 decompressedSize = isLong ? MadScience.StreamHelpers.ReadValueU32(input, false) : MadScience.StreamHelpers.ReadValueU24(input, false);
            ...
            while (true)
            {
                ...
                byte prefix = MadScience.StreamHelpers.ReadValueU8(input);

                if (prefix < 0x80)
                {
                    byte extra = MadScience.StreamHelpers.ReadValueU8(input);
    ...
    {
        public static bool RefPackCompress(byte[] input, out byte[] output, CompressionLevel level)
        {
            return Compression.Compress(input, out output, level);
        }

        public static bool RefPackCompress(byte[] input, out byte[] output)
        {
            return Compression.Compress(input, out output, CompressionLevel.Max);
        }

        public static byte[] RefPackDecompress(byte[] input)
        {
    ...
    {
        public static bool RefPackCompress(Stream input, int length, out byte[] output, CompressionLevel level)
        {
        ...
        public static bool RefPackCompress(Stream input, int length, out byte[] output)
        {
            byte[] data = new byte[length];
            input.Read(data, 0, data.Length);
        ...
        public static byte[] RefPackDecompress(Stream input)
        {
            return Decompression.Decompress(input);
        }
    }
